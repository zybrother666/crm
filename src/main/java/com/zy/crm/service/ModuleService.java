...
public class ModuleService extends BaseService<Module,Integer> {
    ...
    public void addModule(Module module){
        ...
        AssertUtil.isTrue(null != moduleMapper.queryModuleByGradeAndModuleName(grade,module.getModuleName()),"该层级下菜单名已存在！");
    ...
    public void updateModule(Module module){
        ...
        //层级 grade  非空 0|1|2
        Integer grade = module.getGrade();
        AssertUtil.isTrue(null == temp||!(grade == 0 || grade == 1 || grade == 2),"菜单层级不合法！");
