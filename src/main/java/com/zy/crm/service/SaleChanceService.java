...
import com.zy.crm.dao.SaleChanceMapper;
import com.zy.crm.enums.DevResult;
...
public class SaleChanceService extends BaseService<SaleChance,Integer> {
    ...
    *       customerName客户名称    非空
    *       linkMan联系人           非空
    *       linkPhone               非空，手机号码格式正确
    * 2.设置相关参数的默认值
    *       createMan创建人        当前用户登录名
    *       assignMan指派人
    *           如果未设置指派人（默认）
    ...
    * */
    ...
    public void addSaleChance(SaleChance saleChance){
        ...
        if(StringUtils.isBlank(saleChance.getAssignMan())){
            ...
            //devResult（开发状态（0=未开发，1=开发中，2=开发成功，3=开发失败））    1=开发中
